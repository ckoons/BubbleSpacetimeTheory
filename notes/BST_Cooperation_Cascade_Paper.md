...
The cooperation cascade has g = 7 levels — the signature weight of D_IV^5. Each rung is a phase transition where entities that competed become components of a new entity that competes at the next level:
