---
title: "Kempe commutators at a stuck pentagon: an exhaustive census on 5-connected triangulations through 25 vertices — DRAFT v0.3"
author: "Casey Koons, with Lyra, Elie, Grace, Keeper (CI co-authors)"
date: "2026-09-06, Sunday (v0.3 built 15:55 EDT from v0.2 of 2026-09-03 by exact-match edits: the n = 25 row on two instruments — Elie 5601/5664a (prereg 49670a3b) and Grace 5666 (population e9ae614c, lock witness list d4fdec14; 1,171 common, 0 either-only) — in Tables 3.1 and 3.3 and the totals; every 349-specific sentence rescoped to n ≤ 24; the gate/direct sub-split at n = 25 NOT printed (enumeration-order dependent, Grace 09-04 12:19; Elie's confirmation pending); internal, not for dispatch; K1852-C gate on this version owed; B4 deferred to the dispatch copy)"
status: "DRAFT v0.3 (+ Cal §864 heading fix; K1852-C (a) met 16:38 by Elie 5708 = Grace 5666 on the 1,171). Every number below is a census number produced on two independent instruments with blind-hashed witness lists — the stuck colourings themselves, as (n, plantri index, vertex, colouring) — (Appendix B); every lemma marked DERIVED has an artifact and an independent re-derivation on record; every open clause is marked. Nothing in this document claims a proof of the Four Colour Theorem, and nothing in it concerns triangulations with more than 25 vertices."
---
...
**Definitions and the naming ruling (referee's paragraph, Cal §825, with one pointer amended).** *Setting.* T is a
5-connected sphere triangulation (no separating 3- or 4-cycles; every minimal counterexample to the Four Color Theorem
is one, Birkhoff 1913, re-derived in the corpus as A5.1–A5.3); v is a vertex of degree 5; c is a proper 4-coloring of
...
τ_v(c) = 6, every pair of colors operationally tangled (Definition 5). Stuckness forces a single local context up to
symmetry (One-Context Lemma): two copies of one color r at link distance two, a middle vertex of color s_M between
...
**The stuck leaf, in its frames (referee's sentence, Cal §825 §1).** The bridge word's image is stuck exactly when two
...
The n = 25 row is on two instruments (Elie 5601/5664a; Grace 5666, independent pipeline: her Laplacian-rank τ, her
stage and leaf code; the 44,566-record population hashed before any count, the 1,171 lock witness lists hashed before
the diff — 1,171 common, none either-side-only). The 1,520 are commutator-locked at depth one (n = 17: 8 · 21: 18 · 22: 23 · 23: 44 · 24: 256 · 25: 1,171). The classical Kempe
...
reach the gate phase (Lane D, Elie 5606) — a statement about those 49 only; on the 349 the unrestricted plain-swap depth
...
Instruments: Grace toy 5625 (BFS over plain swaps on raw colourings, terminal gate verified by the rank instrument;
records hash 54cd2ced…) and Elie toy 5624 modes A/B/C (independent code; hashes in Appendix B); the two agree exactly on
the 349. At n = 25: Elie toy 5664a (the 5624-B instrument verbatim; prediction "maximum 4, unreached 0" hashed 49670a3b
before the run; 9,376 s) and Grace toy 5666 Part C (her instrument; 119 s — the two-order runtime gap is per-state
cost, not exploration, and no result depends on it), agreeing to the unit in every bin; the depth-1 count 18,341 also
equals the single-swap gate count of the commutator census independently. Read against the menu: a two-word exit is
...
kill are given so the order can be checked. (1) The one-word form of the claim — pre-registered Cal §819–§820 and
Elie 5595–5599 (2026-09-01); refuted in frame by 49 exhaustive witnesses at n ≤ 22 and 349 at n ≤ 24 (Elie 5601/5613,
2026-09-01 to 02); never refuted out of frame in 3,581 configurations. (2) "A lock is where the single-swap null is
zero" — killed by Cal's T1 (2026-09-02, ~11:00): false on 27 of 349. (3) Tunnel non-recurrence along the bridge path —
pre-registered Lyra 2026-09-02 09:43; killed by Cal Lane A (2026-09-02): double tunnels in 194 of 196 trials. (4) Cut
containment as the exit mechanism — pre-registered Lyra 2026-09-02 10:24 (H_cut); killed by Cal on the 93 (2026-09-02):
...
(pre-registered and killed in one artifact, Lyra 2026-09-02 08:06; Keeper K1835 08:10; Cal §818; Appendix C).
(6) Six-bit and 68-bit incidence types as a classification of the lock (Elie 5613/5615, Cal §824 §4, 2026-09-02):
...
**A.** The witness gallery: types, bits, cut anatomy, hashes — Grace, `BST_FourColor_Appendix_A_witness_gallery_349_in_frame_plus_28_DRAFT_v0.1_2026-09-02.md`. **B.** Instruments, hashes, plantri version, witness formats — Elie, `Elie_APPENDIX_B_instruments_hashes_plantri_witness_formats_2026-09-02.md`. **D.** The stage tables in full (L, D, T, the mirrored tree, the letter table) — slot.
