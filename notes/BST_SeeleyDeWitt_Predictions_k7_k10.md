...
| 7 | k = 3 | $g = 7$ | (p-1) = 6 divides 6; signature weight $g=7$ (NOT the Bergman genus = $n_C=5$; NOT the Coxeter number $h=6$; Hua 1963) |
...
This is the dimension of the Lie algebra $\mathfrak{so}(7)$, where $g = 7$ is the signature weight ($= h(B_3) + 1$; the Coxeter number $h = 6 = C_2$; the Bergman genus proper $= n_C=5=h^\vee$, Hua 1963) of the restricted root system of $Q^5$.
