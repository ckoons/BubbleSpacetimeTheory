...
matching the FNAL world average at sub-percent precision. The integer 42 = C_2 · g now appears in **three independent two-loop Standard Model observables** at the percent level:
