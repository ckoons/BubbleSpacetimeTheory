...
**The one-loop beta function coefficient IS the genus g.** Asymptotic freedom holds because b_0 = g > 0, which is guaranteed by the bound g > C_2 (i.e., 7 > 6) proved in T1262. **[IDENTIFIED (this sentence; the "proved in T1262" / "(T1262)" clause is STRUCK as decorative) — 09:48 EDT 2026-09-07, Grace on Cal §888's word (K1875): b₀ = 11 − 2n_f/3 (Gross–Wilczek–Politzer; N_c = 3) = 11, 10.33, 9.67, 9, 8.33, 7.67, 7 for n_f = 0…6 — the flavour sweep is exact and kills "b₀ IS the genus": 7 = g needs TWO inputs, N_c = 3 AND n_f = 6 (three generations × two flavours), so b₀ = 7 is an arithmetic consequence of two identifications and its equality with a third integer g is a coincidence of that arithmetic, not a derivation. WHICH COEFFICIENT IS IN FORCE WHERE THE CORPUS EVALUATES α_s: T2074 evaluates at M_Z (n_f = 5, b₀ = 23/3), m_b ≈ 4.18 GeV (the n_f = 4/5 threshold), m_τ ≈ 1.78 GeV (n_f = 3/4) and m_c — at NONE of them is 7 the coefficient; b₀ = 7 governs only above m_t ≈ 173 GeV, which does include μ_geo = v ≈ 246 GeV (F833), so the integer 7 is in force at the corpus's predict-at-μ_geo scale and at none of its four measured landings. The sign is Gross–Wilczek–Politzer (T2526, re-scoped K1785); the T1262 clause ("g > C₂ proved in T1262") was decorative and is struck.]**
