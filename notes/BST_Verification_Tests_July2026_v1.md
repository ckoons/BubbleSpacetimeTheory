...
| 2 | **Neutrinoless double-beta decay (pred_004)** | **NULL** — neutrinos are Dirac, \|m_ββ\| = 0 exactly (ℤ₃ topology forbids Majorana) | Any confirmed 0νββ detection at any rate → **FATAL** | LEGEND-1000, nEXO, CUPID · 2027–2032 | **S** · untested (sharpest binary test) |
...
| **Majorana neutrinos / 0νββ** | none — Dirac | **FATAL** | KamLAND-Zen null — consistent | pred_004 · S |
