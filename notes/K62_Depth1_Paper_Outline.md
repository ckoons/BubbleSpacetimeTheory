...
### Section 2. What Is AC Depth? (1-2 pages)
...
### Section 3. The Census (2-3 pages)
...
### Section 4. Six Demonstrations (2-3 pages)
- RH, YM, P≠NP, NS, BSD, Hodge — each in 4-5 lines.
- Format: Boundary | Count | One sentence summary.
- Distilled from Koons Machine Section 3 (already written — condense).

### Section 5. The Coordinate Principle (1-2 pages)
- T439: "In the domain's natural spectral basis, every theorem is one evaluation."
- The Copernicus parallel (from Koons Machine Section 6.3).
- Forward's Flouwen (from Koons Machine Section 6.5) — mathematics as entertainment.
- Educational implications: learn definitions, the proof is one step.

### Section 6. The AC Graph (1 page)
...
### Section 7. What This Doesn't Claim (½ page)
...
- Koons Machine Section 3 (Six Demonstrations) — condense to 4 lines each
- Koons Machine Section 5 (C, D analysis) — tables and framework
- Koons Machine Section 6 (Copernicus + Flouwen + education) — key paragraphs
- AC0 Completeness Paper Section 4 (Nine problems) — depth tables
...
- Introduce D_IV^5 only in Section 4 (demonstrations) and only as "a specific bounded symmetric domain."
