...
### Section 1. Introduction: VSEPR's Missing Number
...
### Section 2. The Tetrahedral Anchor: cos(θ) = -1/N_c
...
### Section 3. The Lone Pair Correction: cos(θ) = -1/2^rank
...
### Section 4. Triangular Lone Pair Compression
...
### Section 5. Three Predictions, Zero Parameters
...
### Section 6. Why Not Heavier Atoms?
...
### Section 7. Connection to BST Physics
...
### Section 8. Predictions for Future Work
