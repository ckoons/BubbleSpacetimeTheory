...
- **g = 7**: the signature weight — the spectral gap, the number of layers to coherence
...
And nitrogen — the element that carries information in DNA bases — has atomic number Z = 7 = g (the signature weight). The two most important elements in biochemistry have atomic numbers that are BST integers.
...
The first projects any substrate engineering culture would undertake number **g = 7** — the signature weight again:
...
| Seven layers to coherence | 0 | signature weight |
