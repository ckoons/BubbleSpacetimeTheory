...
- **Muon g-2 A_n loop coefficients = Wallach K-type Dirac eigenvalues**: A_2 numerator 42 = λ_W(3,3) = C_2·g (the universal 42); A_3 = 24 = λ_W(2,2) = χ_K3 (also K3 Euler characteristic); A_4 = 131 = N_max−n_C−1 (spectral gap signature); HVP coefficient 24 recurring at λ_W(2,2) (internal Type C convergence within the muon g-2 expansion).
