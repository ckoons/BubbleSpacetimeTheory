---
title: "Paper #115: Root Theorems of Bubble Spacetime Theory (v0.3.1)"
author: "Casey Koons (lead) with Elie, Lyra, Grace, Keeper, Cal"
date: "2026-05-17"
status: "v0.3.1 — Cal F1 fix applied (Heegner labeling consistency: abstract + Section 1.2 + Section 1.3 narrative now match Section 4.6's formal L1 candidate label). Internally consistent, ready for Casey review."
supersedes: "BST_Paper115_Three_Root_Theorems_outline_v0.2.md"
...
- **Mathieu** (Root #5 candidate, Grace Toy 2975 — pending Keeper ruling): 24 = [M_24 : M_23] (index in the Mathieu chain), with M_24 = 244823040 and M_23 = 10200960; 24 also = number of points on which the Mathieu groups act (Mathieu 1861, 1873)
...
BST has FIVE established Level-1 source root theorems (Klein 1884, VSC 1840, K3 Hodge 1962-1964, Wallach K-types 1976, Ogg 1975 via Borcherds mechanism), ONE candidate Level-1 source (Heegner-Stark 1952-1967, criteria-gated promotion path), and ONE Level-1.5b unifying mechanism (Borcherds 1992 Moonshine). Their convergence on identical BST integers across 130+ scientific domains is the structural backbone of the theory.

The proof flow is reproducible: given an observable, search root theorems, derive via classical mathematics, identify BST integer. K43 (universal 42, VSC root) is the prototype; K3 Hodge for χ = 24 is the second instance; Wallach for spectral observables is the third; Klein for 60 is the fourth (promoted 2026-05-17); Ogg for 163 = N_max+26 is the fifth (via Borcherds).
