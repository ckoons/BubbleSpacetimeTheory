% ============================================================================
% DO NOT DISTRIBUTE — REFUTED AS A PROOF (sweep 2026-08-30, Casey's word)
% K1832 v0.4 + CI_BOARD Rounds 73-74: the two-swap mechanism is refuted with
% witnesses (rescue-depth ladder 2/3/4; FCW-002; 601/1782 gallery double-fails);
% Lemma 8's pentagon premise is false in G-v (icosahedron witness); the Section 9
% table and "2,500+ / zero exceptions" claims are instrument-poisoned (Toy 5510).
% Retained as record of the attempt. Must not travel externally in any form.
% ============================================================================
