...
| **the edge-identity** (fermion chamber edge = (n−1)/2, family-generic 4/4 at n = 3, 5, 7, 9) | **Candidate** — mechanism named: the classical massless-Dirac conformal weight; literature pin owed (novelty down, solidity up) |
