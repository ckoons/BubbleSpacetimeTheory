...
| **binarity from the interface** (commit_ev at ∂Ω; π₀ = 2, ordered-pair datum — Section 2b) | **Theorem** (ratified 2026-08-24) |
| **irreversibility irr_thermo** (erasing the amplified record costs ≥ n·k_BT ln 2 — Section 2b) | **Theorem, conditional on the second law** (statistical-counting import; the two-tier arrow stated once, not double-counted) |
| **the edge-identity** (fermion chamber edge = (n−1)/2, family-generic 4/4 at n = 3, 5, 7, 9) | **Established-imported identification (pin LANDED 2026-08-25):** the edge IS the known spinor unitarity bound — Minwalla, hep-th/9712074, eq. (2.56): "ε₀ ≥ (d−1)/2 (spinor)," saturated by the free Dirac field (Sec. 2.5, verbatim: the saturating operator "obeys the Dirac equation"). BST content = the chamber structure REPRODUCES the bound family-generically; novelty down, solidity up, as pre-agreed |
