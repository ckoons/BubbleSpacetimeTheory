...
made explicit (Toy 625, 8/8): B₂ → ρ=(7/2,5/2) → K(0,0)=1920/π⁵
...
This identity follows from the 1:3:5 root structure of B₂ (the
...
The restricted root system is B₂, with roots in a 2-dimensional
...
**Route 2: Weyl generators.** The Weyl group W(B₂) of D_IV^5 has
...
**Route 4: Orthogonality bound.** The restricted root system B₂
