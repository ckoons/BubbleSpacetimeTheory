---
title: "SP29-1: Cs-137 Casimir-Boundary Decay-Rate Modulation Proposal (v0.2)"
program: SP-29 Casimir Mechanism Investigation
author: "Casey Koons (lead) with Elie (experimental proposal + Decca cross-anchor), Lyra (substrate-dynamics derivation T2362/Toy 3028), Grace (null-model calibration, pending), Keeper (SP29-6 ranking, K-audit), Cal (referee)"
date: "2026-05-18"
status: "v0.2 — Lyra T2362 / Toy 3028 substrate-dynamics derivation INTEGRATED. BST primary prediction now formally derived from H4 (substrate commitment rate slowing under boundary suppression). Grace null-model calibration pending — placeholder Section 7."
supersedes: "BST_SP29_1_Cs137_Casimir_Decay_Proposal_v0.1.md"
target: "Experimental physics collaboration (decay-rate metrology / Casimir physics)"
length: "~12-18 pages full proposal; v0.2 ~13 pages"
related: "SP29-6 master table; W-39 experimental design (May 16); Paper #111 Substrate Dynamics v0.1; T2334-T2336 (Lyra Bergman kernel + cohomology); T2362 / Toy 3028 (Lyra H4 substrate-dynamics derivation, BST primary closure); Toys 3009/3020 (Decca Casimir residual = 3/1507)"
v0.2_changes: "v0.2 changes (2026-05-18 EDT afternoon):
  (1) Author list expanded to full team collaboration
  (2) Section 2 BST H4 hypothesis statement: BST primary form now formally DERIVED per Lyra T2362 / Toy 3028 (substrate commitment-rate slowdown under boundary suppression)
  (3) NEW Section 2.1: Lyra substrate-dynamics derivation from Paper #111 + LAG-1 substrate ontology
  (4) Section 4 placeholder: Grace null-model statistical calibration (TBD)
  (5) Combined SP-29 package update: Lyra's BST prediction half COMPLETE on both SP29-1 (H4) and SP29-2 (H1)"
---
...
## 4. Statistical null-model calibration (Grace, pending v0.3 integration)

[PLACEHOLDER — Grace is filing the formal null-model statistical calibration as
the third partner deliverable in the SP-29 joint proposal. v0.3 will integrate:

  - Null hypothesis: P(observed τ ratio = 1 + 3/1507 | random small-integer ratio)
  - Look-elsewhere correction across BST primary candidate values
  - Joint significance with Decca cross-anchor (same primary form in two phenomena)
  - Calibrated 3σ/5σ thresholds for experimental decision criteria
  - Comparison to Jenkins-Fischbach historical claims at sub-percent level

Grace's null-model adapts the K44 strict-null framework (Sunday May 11+12 work)
to the experimental signal-strength context: distinguishing genuine substrate-coupling
signature from arithmetic coincidence in small-integer ratios.

When filed, this section becomes Section 4 with experimental magnitude analysis renumbered to Section 5.]

## 5. Expected magnitude analysis
