...
*(b) **Erasure overhead.** The minimum overhead per erasure cycle is $1/2^{N_c} = 1/8$ of the total energy budget. This matches the Weyl group fraction: one orientation out of $|W(BC_2)| = 8$ microstates must be selected (erased) per observation.*
