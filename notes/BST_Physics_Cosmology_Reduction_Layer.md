...
| T_id | Name | Shannon | Number Theory | D_IV^5 Geometry | Depth | Plain English |
|------|------|---------|---------------|-----------------|-------|---------------|
| T197 | Weinberg Angle | S12: Dimensional analysis | N7: sin^2(theta_W) = N_c/(N_c + 2*n_C) = 3/13; 0.2% | G1: B_2 root system; short roots (N_c = 3) vs total (N_c + 2*n_C = 13) | 0 | The Weinberg angle measures how much the electromagnetic and weak forces mix. Its sine-squared = 3/13 -- just the ratio of short roots to total roots in the B_2 system. 0.2% match to experiment. |
