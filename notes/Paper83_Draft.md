...
---
*2536 entries (data layer). v4.7: BSD CLOSED (T1465). SP-15 CONVERGED: Theta IS BST. T1466-T1480 registered (15 new theorems). 1419 graph theorems. Counts: D:1394, I:532, C:58, S:206. D-tier 62.1%. Spectral dimension = C_2 = 6 (T1472). Born rule = Bergman (T1473). CKM from Casimir gaps (T1474). QED transcendentally finite (T1470). April 30, 2026.*