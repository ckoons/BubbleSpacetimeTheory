...
- **17 toys** (963-979): percolation CFT, meson NLO, 3D Ising, τ_n Marciano-Sirlin, Jarlskog, neutron NLO, critical exponents wiring, BST Prime Observatory, BiNb SASER frequencies, **pilot gap verification 5/5**, f_π candidate verification, Miss Hunt scorecard, **Størmer-Gödel bridge**, pilot batch 2+3 (stress test 13/15), B_d correction verification (8/8), **η_b verification (8/8)**
- **18 theorems** (T912-T929): VMD-ChPT Bridge, Percolation Central Charge, **T914 Prime Residue Principle**, Prime Observatory, f_π correction, T920 Debye Bridge (θ_D=g³), T921 Thyroid Counting, **T926 Spectral-Arithmetic Closure**, **T927 D-State Correction** (B_d 50/49), **T929 Baryon Asymmetry Closure** (η_b = (3/14)α⁴)
...
**Counter files**: `play/.next_toy` = 978, `play/.next_theorem` = 928. Graph: 889 nodes, 2524 edges (56.9% required). 42 papers. 977 toys. 400+ predictions. 66+ physical domains.
