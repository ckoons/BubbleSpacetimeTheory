...
| G-13 | **BST product lattice + gap predictions** — Lattice of (rank^a · N_c^b · n_C^c) with occupied/empty cells. 6 gaps found. **Keeper K-7 audit**: **80=rank⁴·n_C GENUINE** (bare Cabibbo, 79=80-1). **48=rank⁴·N_c PROMISING** (octahedral group |O_h|=48, investigate). **360/90/100 REJECTED** (angular degrees=Babylonian convention, percent=decimal convention — same category as K-1 removals). **150≈Dunbar REJECTED** (empirical, approximate 100-250, not derived). Grace: retain lattice structure, remove convention-based gaps. | HIGH | **KEEPER AUDIT NEEDED** |
...
| K-7 | **Gap prediction audit** — Grace's BST product lattice: 6 gaps found. **AUDIT**: (1) 80=rank⁴·n_C **GENUINE** — bare Cabibbo denominator (79=80-1), structural. (2) 48=rank⁴·N_c **PROMISING** — octahedral group |O_h|=48=2·24=2·dim SU(5), needs investigation. (3) 360=rank³·N_c²·n_C **REJECTED** — degrees in a circle is Babylonian convention (base-60×6), not physics. Same as "12 semitones" removal from K-1. (4) 90=rank·N_c²·n_C **REJECTED** — same reason. (5) 100=rank²·n_C² **REJECTED** — percent is decimal convention. (6) 150=rank·N_c·n_C² **REJECTED** — Dunbar's number is approximate (100-250), not derived. **Result: 2/6 genuine, 4/6 convention/coincidence.** The lattice structure is good; the gap labels need filtering. | HIGH | **DONE** |
