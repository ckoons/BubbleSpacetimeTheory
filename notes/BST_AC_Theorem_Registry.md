...
| Proved (depth 0) | 4 | T445 (Genetic Code Forcing — five-step chain: rank→4 bases, C₂→6 bits, C₂/rank→3=N_c codon length, Λ³(6)→20 amino acids, C(7,2)→21 outputs. All from BC₂ root system. Zero free parameters. Toy 535 12/12.) |
