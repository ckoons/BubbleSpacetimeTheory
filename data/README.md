...
| **bst_geometric_invariants.json** | **5147 geometric invariants** (+249 weekend: Friday→Saturday→Sunday; Sunday +35 absorbed DCCP arc + Cal #121-#127 + Calibration #25+#27 STANDING + FRAMEWORK-PLUS tier + cross-CI cascade pattern + Bell outreach SENT); **100% integer_set + 100% physical_type + 100% cluster_type tagged**; cluster_type distribution: 3437 TYPE I + 840 TYPE II + 862 structural + 8 other; 2 Hit List P1 STRONG candidates (m_ν₃ INV-4859 sub-0.1% + Li7/H INV-5102 -0.16%); Bell outreach SENT (INV-5145 SP-30-1 Vienna+backups); DCCP arc v0.1→v0.7 with Mode 1 vulnerability HIGH→LOW-MODERATE→2-way discriminable | May 24, 2026 (Sunday EOD) |
| **cross_volume_forward_reference_table_v0_2.json** | Cross-volume forward-reference graph (Sunday EOD refresh): 190 chapters scanned (108 with refs), 334 forward-refs; top-10 most-cited now Vol 5 Ch 1+3 (9 each), Vol 12 Ch 1 (7); refresh post Vol 12-15 Keeper deep rewrites; CI tutor navigation backbone (INV-5095/5096) | May 24, 2026 (Sunday EOD refresh) |
