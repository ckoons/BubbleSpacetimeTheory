...
| **bst_geometric_invariants.json** | **5170 geometric invariants** (+23 Monday Memorial Day; weekend cumulative +272 Fri→Sat→Sun→Mon). Monday added: Mode-6 sweep harness (5148-5149) + 8 Casey-interpretive-prompt cascade INVs across Thread 2 multi-axial substrate enumeration (5167 = 6 substructures + 5 boundary types; 5168 = 3-CI convergent multi-axial; 5169 = Axis G half-integer Pin(2) cover; 5170 = Casey Phase-2 directive THREE OPERATIONAL GAPS canonical). **100% integer_set + 100% physical_type + 100% cluster_type tagged** | May 25, 2026 (Monday Memorial Day EOD) |
| **cross_volume_forward_reference_table_v0_3.json** | Cross-volume forward-reference graph (Monday EOD refresh): 202 chapters scanned (98 with refs), 422 forward-refs; 37 HUBs + 49 APPLICATIONs + 10 WORKHORSEs; refresh post-Memorial-Day Keeper DCCP sweep #302 (Vol 0 Ch 3 + Vol 5 Ch 7+10 + Vol 14 Ch 4) | May 25, 2026 (Monday EOD refresh) |
| **cross_volume_forward_reference_table_v0_2.json** | Previous version (Sunday EOD) — 190 chapters, 334 refs | May 24, 2026 |
...
## Current Stats (May 25, 2026 Monday Memorial Day EOD — multi-axial substrate enumeration day)
