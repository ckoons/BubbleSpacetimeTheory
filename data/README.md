...
| **bst_geometric_invariants.json** | **5275 geometric invariants** (+33 Thursday May 28; 5190 Tue → +52 Wed → +33 Thu). Thursday = genus/Bergman/c_FK recheck day → A1 PRIMARY unblock+fix. Key: c_FK now DERIVED THEOREM (FK measure forced by Born/Gleason); ρ-vector (n_C,N_c)/rank=(5/2,3/2) pins 3 primaries bulk/Shilov; **ONE genus = n_C = 5** (corrected from morning 'three-genus' mislabel — C_2=6=Casimir, g=7=embedding, neither a genus); Weinberg rank+g=N_c²; **4 standing conventions** (genus[corrected]/α/7-2/Macdonald-parameter base 2 = Macdonald t); N_max=2^g+N_c²=137. **4 catalog-defensibility fields**: region (5275: SHILOV 508/BULK 522/BOUNDARY 106/CHAIN 313/OTHER) + scheme_sensitivity (341) + validating_axis (5275; 115 forward-spine manual-curated) + rho_component (32). **100% integer_set + physical_type + cluster_type tagged**; catalog genus-clean (4 residuals swept). | May 28, 2026 (Thursday EOD) |
