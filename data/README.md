...
| **bst_geometric_invariants.json** | 4631 geometric invariants with formulas, precision, D/I/C/S tiers, section mapping for Paper #83 | May 20, 2026 (PM) |
...
- **Theorems**: T1-T2427 (2170 nodes in graph, 9802 edges; **290 zone-tagged = 13.4% coverage**)
...
- **Graph**: 2170 nodes, 9802 edges, ~98% proved; **290 substrate-level nodes commitment-cycle-zone-tagged (13.4% coverage)** across 3 batches; Z3 emission dominates (~96 nodes, ~37%) consistent with Bergman framework as foundational layer
