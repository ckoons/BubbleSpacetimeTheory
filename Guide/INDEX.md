...
>
> **Identified** (formula matches; mechanism not claimed): α⁻¹ = 137-class expressions · the electron's anomalous moment (our four "Selberg terms" are the four summands of Petermann–Sommerfield's 1957 closed form; the match is real, the derivation is not ours) · the asymptotic-freedom coefficient b₀ = 7 read as g · the exact mixing values · Newton's G in its m_e-anchored form · assorted precision matches whose own null tests show small-integer expressibility is cheap.
>
