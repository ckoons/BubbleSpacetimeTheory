---
title: "BST Working Paper — Volume 2: The Framework — Chapter 1: Foundations"
volume: 2
volume_title: "The Framework"
chapter: 1
chapter_topic: "Foundations"
parent: "./INDEX.md"
...
- **The look-elsewhere price of the selector:** over all 102 irreducible domains of dimension $\leq 30$ and a six-item menu of invariants, "some invariant equals $3$" is carried by 24 domains; the specific invariant $a = 3$ by one (Elie 5751 E2). The honest version of that price is toy 5753 (Round 142): of 48 natural (invariant, target) stories, 7 select a unique domain stably, on 6 domains, ours by one — and the control that matters, *the invariant $a$ selects a unique domain for 25 of the 29 integer targets from 2 to 30*, so the number three is not special to the invariant; the invariant is. Had colour come in seven, the same theorem would have picked $D_{IV}^9$. (Added at Keeper's audit, 2026-09-14.) The selector's strength rests on the invariant having been named before the target, which is a history question the register records and does not rule.
...
| Fermi scale $v$ (Higgs vev) | $m_p^2/(g \cdot m_e) = 36\pi^{10}m_e/7$, $g = 7 = p + q$ (not the genus) | **0.046%** (identified) | 14.7 |
