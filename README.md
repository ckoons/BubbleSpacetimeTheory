...
| `notes/` | 86 numbered papers, 660+ research notes, theorem write-ups, proofs | `notes/README.md` |
| `play/` | 1525+ toys (computational verifications), HTML visualizers, BST Appliance, AC theorem graph | `play/README.md` |
