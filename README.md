...
**Status (March 25, 2026):** All six problems resolved at AC(0) depth ≤ 2 via the Koons Machine (see below). RH ~95% (paper v9, sent to Sarnak). YM ~95% (all 5 Wightman axioms). P≠NP ~95% (FOCS submitted). **NS ~98%** (proof chain complete, K36 PASS). **BSD ~93%** (K37 CONDITIONAL PASS, 13 toys all passing). **Hodge ~93%** (two-path proof v21: Version A substrate/T153 ~90%, Version B classical Deligne+Tate ~88%, independent failure modes; weight ≥ 3 wall eliminated). Poincaré solved (Perelman 2003). AC-flattened proofs for all six: `notes/BST_*_AC_Proof.md`.
...
Six problems. Six boundaries. Six counts. All depth ≤ 2:
