...
| Riemann unified proof | 5-layer argument: Chern → transport → c-function → arithmetic → code rigidity; all 3 gaps addressed; one bridge remains | structural |
