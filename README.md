...
**The spectral zeta function — poles, residues, and the 1/60 theorem**: ζ_Δ(s) = Σ d_k/λ_k^s converges for Re(s) > 3 and has poles at s = 5, 4, 3, 2, 1 with residues proportional to Seeley-De Witt coefficients A₀–A₄. The s = 3 pole has logarithmic divergence coefficient exactly **1/60 = 2/5! = 1/|A₅| = 1/|gauge sector|** (verified numerically to 8 figures). The number 60 = n_C!/2 = |icosahedral group| = dim(gauge sector in E₈). The s = 3 residue involves c₁² and c₂ — exactly the Chern data that constrains ζ-zeros through the Selberg trace formula. Convergent values: ζ_Δ(4) ≈ 0.00666, ζ_Δ(5) ≈ 0.000966, satisfying ζ_Δ(s) ~ Vol(D)^{s-4} × C(s). The half-sum |ρ|² = 17/2 sets the continuous spectrum threshold. See `notes/BST_SpectralZeta_PoleStructure.md`.
