...
**Status**: Working research program — v36, May 2026 | **Curriculum**: 16-volume textbook (Vol 0-15) at v0.3+ substantive content (Keeper deep-pass complete 2026-05-24); Vol 16 Substrate Algebra (A_sub) + Vol 17 Substrate Engineering QUEUED as extensions when triggers fire. | **Substrate-mathematics paper series (14 papers) in internal draft** — A1 *The Substrate Hall Algebra of D_IV⁵* (PRIMARY) at internal Keeper PASS v0.4 (2026-05-28). **Week of 2026-05-26**: the substrate Hall algebra is identified as the Hall-Littlewood corner (Macdonald q=0, t=2) of one Macdonald family whose Jack corner is the substrate geometry; the quantum measure is derived as a theorem (the Faraut-Korányi measure is forced by Born-rule/Gleason invariance, not assumed); methodology stack at v0.9 (Calibrations through #31 STANDING, #32 candidate). SP-30-1 Bell sub-Tsirelson outreach sent (Zeilinger IQOQI Vienna)
