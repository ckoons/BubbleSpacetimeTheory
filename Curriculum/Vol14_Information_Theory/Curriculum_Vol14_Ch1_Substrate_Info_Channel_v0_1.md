...
**Open category-discipline question** (Lyra standing question for Cal): is $\mathcal{A}_{sub}$ being substrate-foundational a category mistake? Substrate D_IV⁵ is the geometric foundation; $\mathcal{A}_{sub}$ is operator structure ON that foundation. Calling $\mathcal{A}_{sub}$ "substrate's native language" might be confusing geometric foundation with algebraic superstructure. Worth Cal tier-discipline cold-read.
