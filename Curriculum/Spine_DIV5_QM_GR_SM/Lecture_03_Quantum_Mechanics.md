...
Ten of ten. We have said "ten of ten, zero posits" in many places; the honest form is "zero posits *among the axioms*, on a ratified floor that itself contains one posit — rank $= 2$ (K1815)" — and Cal ruled in September (Section 945) that a completeness count with no registry row of its own is a claim no audit was ever obliged to check. The row is owed. Until it exists we quote the count at the tier of the rows it rests on, which are listed above, and not as a headline.
