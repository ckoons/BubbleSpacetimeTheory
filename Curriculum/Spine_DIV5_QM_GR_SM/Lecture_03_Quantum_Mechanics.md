...
sources: "The Axioms paper (notes/BST_paper_Axioms_of_QM_from_D_IV5_DRAFT_2026-08-04.md; Cal-vetted Section 447, Keeper PASS); the W1 resolution of 2026-08-22 (the physical Hilbert space is H²); T754 (Born from the invariant measure, Gleason), T753 (uncertainty as Robertson–Schrödinger on H²; the curvature was never in the proof — repaired 2026-09-14, Lyra L3, Cal Section 960), T2543 (Code-Forces-Fermion; colour clause ruled struck 09-09, row edited 09-11 — d7c4e474), T2545, T2401 (Born = Bergman projection, v0.1), T2630 (the Born-resolution row, with Cal Section 935's caveat verbatim), K1815 (the Internal-A floor), K1880–K1888 (the substrate lane; K1888 is the ruling on T2401 and the rate), Cal Sections 935 and 945 (the 10/10 count needs a registry row)"
...
| 5 | uncertainty, $\Delta x\,\Delta p \geq \hbar/2$ | the Robertson–Schrödinger inequality on $H^2$ with $[x,p] = i\hbar$ — an external theorem, two evaluations (T753 as repaired 2026-09-14). The row's curvature sentence, $H = -2/7$, was cited and never used — decoration inside a proved row, and $-2/7$ was $D_{IV}^7$'s number besides (toy 5754). If curvature is ever to bear weight it enters by weight: $H_\nu \in [-2/\nu, -1/\nu]$, so $[-4/5, -2/5]$ on $H^2$ | proved — and **not distinctive**: the Axioms paper called this the one distinctive support axiom, and that sentence falls with the repair (Cal Section 960; his own Section 447 vet had cleared it) |
...
On row 10, one repair, now landed: T2543 also said that the middle Peirce space "is colour." That clause was ruled struck on 09-09 and edited out of the row on 09-11 (Grace, d7c4e474). The theorem about records and idempotents never used it and stands.
