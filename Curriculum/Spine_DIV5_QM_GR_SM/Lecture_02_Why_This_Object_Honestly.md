...
Compare what the other obvious criteria leave: rank $= 2$ alone leaves 26 domains in the table's range (rank two contains two infinite families); complex dimension $5$ alone leaves two; $a = 3$ alone leaves one. One leg, one integer.

## Where the measurement enters

Quarks come in three colours. That is a fact about the world, established at accelerators, owing nothing to any geometry. The one dimensionless input to the *choice of the object* is the sentence:
