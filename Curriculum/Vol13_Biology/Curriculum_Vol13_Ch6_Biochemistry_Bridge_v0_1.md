---
title: "Vol 13 Chapter 6 — Biochemistry Bridge"
author: "Keeper (author pass — deep math/physics revision)"
date: "2026-05-24 Sunday"
status: "v0.3 — substantive content"
volume: "Vol 13 Biology from D_IV⁵"
chapter: 6
load_bearing: "Biochemistry; enzymes; metabolism; bridge from Vol 12 chemistry to Vol 13 biology"
---

# Chapter 6 — Biochemistry Bridge
...
Adenosine triphosphate. Hydrolysis: ATP → ADP + Pi + 30.5 kJ/mol (at standard conditions; ~50 kJ/mol in vivo).

Universal energy currency across all known life. ~10^21 ATP molecules / human / day.

Synthesized by ATP synthase (mitochondria) via chemiosmotic proton gradient (Mitchell 1961, Nobel 1978).

### 6.3 Metabolic pathways

- **Glycolysis**: glucose → 2 pyruvate + 2 ATP + 2 NADH (~10 steps)
- **Citric acid cycle**: pyruvate → CO₂ + ATP + NADH + FADH₂ (~10 steps)
- **Oxidative phosphorylation**: NADH + O₂ → H₂O + ~30 ATP (chemiosmosis)
- **Photosynthesis** (light → chemical energy): light + H₂O + CO₂ → glucose + O₂

Net glucose oxidation: $C_6H_{12}O_6 + 6O_2 \to 6CO_2 + 6H_2O$, $\Delta G$ ≈ −2870 kJ/mol → ~30-32 ATP/glucose.
