---
title: "Vol 4 Chapter 11 — Gravitational Waves and NANOGrav"
author: "Keeper (author pass)"
date: "2026-05-23 Saturday"
status: "v0.2 — Keeper author-voice pass; NANOGrav peak frequency 6.4 nHz, γ = 13/5+1 = 3.60, BH as eigentone configuration"
...
The NANOGrav collaboration detected a stochastic gravitational-wave background in 2023, with a peak frequency near a few nanohertz. The signal's spectral index $\gamma$ is the key observable distinguishing different source models.

BST predicts:

$$\nu_{\text{peak}} \approx 6.4 \text{ nHz}, \qquad \gamma \;=\; \frac{c_3}{n_C} + 1 \;=\; \frac{13}{5} + 1 \;=\; 3.60.$$
