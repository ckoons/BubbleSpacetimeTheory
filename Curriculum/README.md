...
> *Last accuracy-synced: 2026-09-13 10:15 (K1895/K1896; Round 143 absorbed — Lecture 4 on H² by Cal's ruling, register v0.7, the generated count). The T2543 colour clause, ruled struck 09-09, was edited out of the row on 09-11 (d7c4e474). This block lives in `notes/BST_PRESENTATION_STATE_BLOCK.md` and is copied into every front matter by `play/sync_presentation_state.py`. Edit it there, nowhere else. Where any chapter and this block disagree, the block wins; where this block and the theorem registry disagree, the registry wins.*
>
