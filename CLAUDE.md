...
| `play/` | 1,375+ toys (computational verifications), HTML visualizers, BST Appliance | `play/README.md` |
...
- **`play/ac_graph_data.json`** — AC theorem graph: 1399 nodes, 7166+ edges, 52 domains
