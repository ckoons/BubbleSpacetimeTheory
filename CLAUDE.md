...
| `play/` | 1,316+ toys (computational verifications), HTML visualizers, BST Appliance | `play/README.md` |
...
- **`play/ac_graph_data.json`** — AC theorem graph: 1292 theorems, 6636 edges, 52 domains
