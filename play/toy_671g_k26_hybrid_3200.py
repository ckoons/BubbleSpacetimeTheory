...
TARGET_K = 26  # k=26 cascade (bridge between speaking pair 5 k=24,25 and pair 6 k=29,30)

# HYBRID CUTOFF: n <= this use 1600-dps data; n > this compute fresh
HYBRID_CUTOFF = 40

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
CKPT_DIR = os.path.join(SCRIPT_DIR, "toy_671_checkpoint_k26")  # separate dir from k=22 (toy_671d)
os.makedirs(CKPT_DIR, exist_ok=True)

# Log file for long-running output
LOG_FILE = "/tmp/toy_671g_k26_hybrid.log"
