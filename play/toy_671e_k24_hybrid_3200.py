...
TARGET_K = 24  # k=24 cascade (bridge between speaking pair 4 k=20,21 and pair 5 k=24,25)

# HYBRID CUTOFF: n <= this use 1600-dps data; n > this compute fresh
HYBRID_CUTOFF = 40

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
CKPT_DIR = os.path.join(SCRIPT_DIR, "toy_671_checkpoint_k24")  # separate dir from k=22 (toy_671d)
os.makedirs(CKPT_DIR, exist_ok=True)

# Log file for long-running output
LOG_FILE = "/tmp/toy_671e_k24_hybrid.log"
