...
TARGET_K = 25  # k=25 cascade (speaking pair 5; predicted ratio = -60 = -rank·n_C·C_2)

# HYBRID CUTOFF: n <= this use 1600-dps data; n > this compute fresh
HYBRID_CUTOFF = 40

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
CKPT_DIR = os.path.join(SCRIPT_DIR, "toy_671_checkpoint_k25")  # separate dir from k=22 (toy_671d)
os.makedirs(CKPT_DIR, exist_ok=True)

# Log file for long-running output
LOG_FILE = "/tmp/toy_671f_k25_hybrid.log"
