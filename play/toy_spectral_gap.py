...
print()
print("  ★ Curvature Operator Spectrum:")
print("    Eigenvalues of R on Λ^{1,1}: {n_C=5, r=2, 0}")
print("    Multiplicities: {1, dim SO(5)=10, n_C²-c₂=14}")
print("    Tr(R²) = 5² + 10×2² = 65 = n_C × c₃")
print("    |Rm|² = c₃/c₁ = 13/5 (Killing normalization)")
print()
print("  ★ H₅ = 137/60:")
print("    1 + 1/2 + 1/3 + 1/4 + 1/5 = 137/60")
print("    numer = N_max = 137, denom = n_C!/2 = 60")
print("    See: toy_harmonic_alpha.py")
print()
print("  ★ GRAND IDENTITY (March 16):")
print("    d_eff = λ₁ = χ = C₂ = 6")
print("    Effective spectral dimension = mass gap = Euler char = Casimir")
print("    Z(t) ~ 1/(60·t³) → d_eff = 6, not 10")
print("    10 = 6 + 4: spectral + spacetime")
print("    f = d_eff/(d·π) = 3/(5π) = 19.1% (fill fraction DERIVED)")
print("    See: toy_effective_dimension.py")
print()
print("  ★ ZONAL SPECTRAL COEFFICIENTS (March 14):")
print("    r_0=1, r_1=5=c_1, r_2=12=2C_2, r_3=1139/63, r_4=833/45, r_5=137/11=N_max/c_2")
print("    For k>=3, all r_k come from Euler-Maclaurin boundary corrections (zero continuum)")
print("    |rho|^2 = 17/2 explains factor 17 in r_3 and r_4")
print("    See: extract_zonal_coefficients.py")
