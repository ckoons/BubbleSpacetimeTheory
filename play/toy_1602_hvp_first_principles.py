...
print(f"  5b (genus bottleneck): T1462 — genus bottleneck at n=3 causes vacuum subtraction,")
...
print(f"    - Connection between genus bottleneck mechanism and HVP integrand")
