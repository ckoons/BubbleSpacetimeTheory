...
EXCL = re.compile(r"retired|struck|withdrawn|corrected|re-tiered|identified|not the genus|is the signature|the signature|fired and lost|closed negative|do not claim|not claim|no longer|mnemonic|was D\b|K1[6-9]\d\d|Section 9[34]\d|Spine|imported|in May|the May", re.I)
