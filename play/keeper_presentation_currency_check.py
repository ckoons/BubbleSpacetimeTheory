...
EXCL = re.compile(r"retired|struck|withdrawn|corrected|re-tiered|identified|not the genus|is the signature|the signature|fired and lost|closed negative|do not claim|not claim|no longer|mnemonic|was D\b|K1[6-9]\d\d|Section 9[34]\d|Spine|imported|in May|the May|until 2026-09-11|until September 2026|surface genus|not \\?"zero free parameters|is not .zero free parameters|p \+ q|p\+q|defining representation|Hawking fine structure|candidate principles|Hubble floor|H_5 = 137/60|derivable from its primary|identification tier|once wrote|does not now|wrong in the other direction|not \$?137\$? turns|19 free parameters|SPARC|rotation.curve|over-claim", re.I)
