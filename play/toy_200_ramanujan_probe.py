...
def section_11():
    ...
    lines.append("    ◇ Bridge mechanism: M(w₀) poles at ξ-zeros (Section 5.1 of UnifiedProof)")
...
def section_12():
    ...
    lines.append("  • The type-by-type elimination (Section 7) is a SKETCH, not a proof")
    lines.append("  • The Golay construction (Section 9) is a CONJECTURE, not a theorem")
