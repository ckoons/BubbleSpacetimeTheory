...
**2,119+ computational toys, 6 interactive HTML visualizers, and the BST Appliance for Bubble Spacetime Theory.**
...
| Metric | Count |
|--------|-------|
| Toy scripts (toy_*.py) | 2,119+ |
| Numbered toys (toy_NNN_*.py) | 1,910+ |
| Named toys (toy_name.py) | 209 |
| Utility scripts (non-toy .py) | 58 |
| HTML visualizers | 6 |
| Theorems (T1-T1787+) | 1,787+ |
| Next toy number | 2123 |
| Predictions | 600+ |
| Domains touched | 130+ |
| Free parameters | **0** |
...
```
play/
  toy_NNN_name.py          # Numbered toys (1,910 files, T100-T2122)
...
|------|---------------|---------|
| `.next_toy` | 2123 | Next available toy number |
| `.next_theorem` | 1788 | Next available theorem number |
