...
Coordinates with Lyra's L-16 (Toy 1573, 7/7: structural genus hole prediction).
This toy provides the NUMERICAL verification and extension.

BST PREDICTION (genus hole mechanism, Paper #86 Section 12.8):
...
Tests:
  ...
  T8: Genus hole cycle trace — content type vs cycle position
...
print("  E-14: Genus hole prediction meets numerical test")
...
# The BST genus hole prediction adds STRUCTURE to BK:
...
# BST does, via the three-phase cycle and genus hole mechanism.

print("  Broadhurst-Kreimer: new MZV ingredient at L loops has weight <= 2L-1")
print("  BST genus hole: WHICH weight-w ingredient depends on prime vs composite")
print()
print("  Comparison:")
...
print("    BST: zeta(9) is EXCLUDED (9=N_c^2 composite, genus hole cycle)")
print()
...
content_types = {
    ...
    4: "zeta(7) + Li_6(1/2) (distribute, genus hole exit)",
...
print()
print("  The genus hole at L=3 (DOF=g=7, Chern position n=3):")
...
print(f"  T8 {'PASS' if t8_pass else 'FAIL'}: Genus hole cycle trace consistent")
...
print(f"    zeta(g)    = zeta(7) at L=4 (last new per genus hole)")
...
print("  BST predicts (genus hole mechanism + cyclotomic structure):")
print()
...
print("      At L=4 (distribute phase, genus hole exit): Li_6(1/2) prominent.")
...
print("    not uniquely BST, BUT BST gives a geometric MECHANISM (genus hole)")
