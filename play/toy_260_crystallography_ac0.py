...
# ═══════════════════════════════════════════════════════════════════
# §2. FORWARD PROBLEM: Structure → Diffraction
# ═══════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════
# §3. THE PHASE PROBLEM — Information Lost
# ═══════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════
# §4. DIRECT METHODS: Sayre Equation Phase Recovery
# ═══════════════════════════════════════════════════════════════════

print(f"\n§4. DIRECT METHODS — SAYRE EQUATION")
print("-" * 50)
...
# ═══════════════════════════════════════════════════════════════════
# §5. RECONSTRUCTION — Inverse Fourier
# ═══════════════════════════════════════════════════════════════════

print(f"\n§5. ELECTRON DENSITY RECONSTRUCTION")
print("-" * 50)
...
# ═══════════════════════════════════════════════════════════════════
# §6. INFORMATION BUDGET — The AC Calculation
# ═══════════════════════════════════════════════════════════════════

print(f"\n§6. INFORMATION BUDGET (AC CALCULATION)")
print("=" * 72)
...
# ═══════════════════════════════════════════════════════════════════
# §7. PIPELINE DECOMPOSITION — Level by Level
# ═══════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════
# §8. POWDER DIFFRACTION CONTRAST — AC > 0
# ═══════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════
# §9. COMPARISON: CRYSTALLOGRAPHY vs BST
# ═══════════════════════════════════════════════════════════════════

print(f"\n§9. CRYSTALLOGRAPHY vs BST — Two AC(0) Sciences")
print("-" * 50)
...
print(f"\n§10. SUMMARY — AC Numbers for Crystallography")
print("=" * 72)
