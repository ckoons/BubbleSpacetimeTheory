#!/usr/bin/env python3
"""
Toy 671b — k=20 Phase B: Full Computation at dps=1600
======================================================
Generates fresh heat trace checkpoints at dps=1600 for n=3..50
...
Phase B steps:
  ...
  2. Compute heat traces at dps=1600 (~2-6 hours)
